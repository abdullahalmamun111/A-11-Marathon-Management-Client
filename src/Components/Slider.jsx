    ...
    const slides = [
        {
          ...
          description: "Your contribution can turn a small idea into a life-changing innovation. Support now!",
          buttonText: "Donate",
        },
        {
          image: img_2,
          title: "Empower Change Together",
          description: "Join hands to fund creative ideas and impactful causes. Together, we can make a difference.",
          buttonText: "Get Involved",
        },
        {
          image: img_3,
          title: "Hope in Every Contribution",
          description: "Every donation you make brings hope and creates opportunities for those in need.",
          buttonText: "Join Us",
        }
      ];
